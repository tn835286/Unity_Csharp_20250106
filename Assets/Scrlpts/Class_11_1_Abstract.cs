...
namespace KAI
{
    ...
    /// 抽象
    /// </summary>
    public class Class_11_1_Abstract : MonoBehaviour
    {
        private void Awake()
        {
            //抽象類別:
            ...
            var threeHornDragon = new ThreeHoronDragon();
        ...
        public abstract class Monster
        {
            ...
            public void Track()
            {
                LogSysytem.LogWithColor("追蹤", "#f93");
            }
        }
        ...
        public class FlyDragon : Monster
        {
            ...
            {
                LogSysytem.LogWithColor("飛龍攻擊", "#f77");
            }
            
            public void Track(int speed)
            {
                LogSysytem.LogWithColor($"追蹤，速度：{speed}", "#f93");
            }
        }

        public class ThreeHoronDragon : Monster
        {
            public override void Attack()
            {
                LogSysytem.LogWithColor("三角龍攻擊", "#7f7");
            }
        }
