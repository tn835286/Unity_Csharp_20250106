...
namespace KAI.Class_15
{
    ...
    /// 介面 interface
    /// </summary>
    public class Class_15_1_Interface : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            LogSysytem.LogWithColor($"隨機:{random}", "#f33");
    ...
    public class Prop
    {
        public void Use()
        {
            LogSysytem.LogWithColor("使用道具，恢復體力", "#f96");
        }
    }
    ...
    public class Equipment
    {
        public void Use()
        {
            LogSysytem.LogWithColor("使用裝備，裝到對應位置", "#9f6");
        }
    }
    ...
    public class Map
    {
        public void Use()
        {
            LogSysytem.LogWithColor("使用地圖，開啟地圖功能", "#96f");
        }
    }
